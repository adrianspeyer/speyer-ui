...
SUI ships 538 purpose-built SVG icons. New icons are welcome — especially for under-represented categories. Before starting, check the [icon browser](https://adrianspeyer.github.io/speyer-ui/icons.html) to see if the icon (or a close variant) already exists.
