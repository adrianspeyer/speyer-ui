...
SUI ships 536 purpose-built SVG icons with built-in accessibility. Icons are optional — bring-your-own is fully supported: Heroicons, Phosphor, Font Awesome, plain SVG, or anything works alongside or instead of SUI Icons.
